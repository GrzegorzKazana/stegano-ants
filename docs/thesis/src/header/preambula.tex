...
\newcommand{\autor}{Grzegorz Michał Kazana}
\newcommand{\albumnum}{338030}
\newcommand{\promotor}{dr hab. inż. Mariusz Boryczka}
\newcommand{\tytul}{Zastosowanie optymalizacji mrowiskowej do ukrywania danych w obrazach cyfrowych}
\newcommand{\unisl}{Uniwersytet Śląski w Katowicach}
