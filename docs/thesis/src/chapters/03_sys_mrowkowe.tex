\chapter{Systemy mrówkowe i mrowiskowe}\label{chap:antsys}
{
    ...
    \section{Rodzaje systemów mrówkowych}
    {
        ...
        \subsection{Model feromon cykliczny}
        {
            ...
            wariantu algorytmu z feromonem cyklicznym, najlepsze rezultaty osiągano dla współczynnika odparowania $\rho$
            bliskiemu $0.5$, i wartości $\alpha$ i $\beta$ będących w stosunku $\frac{\beta}{\alpha}$ zbliżonym do
            zakresu $[2.5, 5]$  \cite{Dorigo1991AntSA}.}
        ...
        \subsection{System mrowiskowy}
        {
            ...
            \begin{itemize}
                ...
                feromonowego -- jest to strategia eksploatacji. W przeciwnym razie, kolejne miasto $s$ zostanie wybrane
