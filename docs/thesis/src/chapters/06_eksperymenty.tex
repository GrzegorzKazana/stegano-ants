\chapter{Wyniki eksperymentów}\label{chap:results}
{
    ...
    \ref{sec:method}, postanowiono przeprowadzić eksperymenty. Ich celem była walidacja fundamentalnych założeń, takich
    jak słuszność doboru złożonych sekcji obrazów, sprawdzenie zasadności sposobów wyznaczania reprezentacji grafowej
    problemu i interpretacji śladu feromonowego, numeryczna ocena degradacji jakości steganogramu oraz subiektywna ocena
    postrzegalności tych zmian. Numeryczna ewaluacja degradacji jakości obrazu pozwoli odnieść uzyskane wyniki do
    istniejących rozwiązań oraz stwierdzić, czy zaproponowane metody mają swoje zastosowanie.
    ...
    \section{Metoda badawcza}
    {
        ...
        \subsection{Obrazy}
        {
            ...
            \textnormal{(}USC\textnormal{)}} \cite{USCDatabase}. Przedstawione są na rysunku \ref{fig:exp-images}.
        ...
        \subsection{Dane}
        {
            ...
            zadaną liczbę bitów tekstu. Pozwoli to na zbadanie degradacji jakości w zależności od objętości ukrywanego
        ...
        \subsection{Badane parametry}
        {
            ...
            \begin{enumerate}
                ...
                \begin{itemize}
                    \item Metoda oparta na wierzchołkach. Jedynym parametrem jest opcjonalny parametr skalujący $s_0$
                    ...
                    prostego podziału na prostokąty, algorytm k-średnich oraz algorytm \textit{SLIC} służący do
                ...
                \begin{itemize}
                    ...
                    skonstruowanych na podstawie segmentacji obrazu wynosi jest ona równa liczbie wierzchołków $V$
    ...
    {
        %
        Eksperymenty rozpoczęto od analizy wyników uzyskanych metodą opartą na budowanie grafu na podstawie
        wierzchołków.
        ...
        \subsection{Metoda oparta na wierzchołkach}
        {
            ...
            kolorem). Kolumna druga przedstawia macierze maskujące, które będą decydować o liczbie bitów które zostaną
            ...
            Ponieważ problem rozwiązywany przez mrówki nie jest równoważny z problemem komiwojażera, konieczne jest
            również ustalenie parametru $S$ określającego liczbę kroków wykonywanych przez każdą mrówkę w każdej
            iteracji algorytmu.
            ...
            znalezienie najkrótszej ścieżki łączącej $S + 1$ pikseli spośród $w \times h$ pikseli nie przyczynia się do
            ogólnego wyznaczenia obszarów obrazu.

            Na dodatkową uwagę zasługuje system z cykliczną reguła aktualizacji śladu feromonowego, gdyż za jego pomocą
        ...
        \subsection{Metoda oparta na krawędziach}
        {
            ...
            grafie pełnym o $|V|$ wierzchołkach $|E| = \frac{|V| \times (|V| - 1)}{2}$. Problem komiwojażera osadzony na
            ...
            uzyskanych steganogramów możemy zauważyć gołym okiem mankament wariantu w którym długość grafu jest
            ...
            wszystkich krawędzi których jest $\frac{|V| \times (|V| - 1)}{2}$. Oznacza to, że gdy system mrówkowy
            osiągnie zbieżność ślad feromonowy na wszystkich krawędziach poza tymi należącymi do najkrótszej ścieżki
            będzie bliski zeru. W takim przypadku, do ukrycia zadanej informacji zostanie wykorzystana jedynie znikoma
            część obrazu nośnego, co negatywnie wpływa na pojemność steganogramu. Wykres \ref{fig:exp-edge-v-vs-e}
            ...
            $\alpha$). Dzięki temu, większa liczba krawędzi będzie odwiedzana, lecz wnosi to również ryzyko otrzymywania
            nieoptymalnych cykli. Alternatywą jest odwrócenie problemu reprezentowanego przez graf. Jeśli długości
            krawędzi będą proporcjonalne do różnic wariancji łączonych segmentów, mrówki będą dążyć do znalezienia $V$
            krawędzi w których nie należy umieszczać informacji, gdyż nie są wystarczająco złożone. W ten sposób,
            uzyskany ślad feromonowy wskaże $|V| - \frac{|V| \times (|V| - 1)}{2}$ segmentów w których powinno zostać
            ukryte najwięcej informacji.
            ...
            systemu mrówkowego. Metodę ich wyznaczenia można znaleźć w rozdziale \ref{chap:implementation}.
            ...
            zakodowanie nieoptymalnej liczby bitów w wszystkich pikselach segmentu. Zbyt wysoka liczba, oprócz większej
            ...
            \begin{figure}
                ...
                \caption[Macierze maskujące.]
                {
                    ...
                    wyznaczone metodą k-średnich (\subref{fig:exp-edge-method-kmeans1},
    ...
    \section{Porównanie wyników z innymi metodami}
    {
        ...
        \begin{table}
            ...
            \caption{Porównanie miar jakości z uzyskanymi metodą \textit{LSB} w pracy ,,LSB Substitution and PVD
        ...
        \begin{table}
            ...
            \caption{Porównanie miar jakości z uzyskanymi metodą \textit{PVD} w pracy ,,LSB Substitution and PVD
            performance analysis for image steganography''}
        ...
        \begin{table}
            ...
            \caption{Porównanie miar jakości z uzyskanymi metodą \textit{PSO-IWT} w pracy ,,A Novel Image Steganographic Method based on Integer Wavelet Transformation and Particle Swarm Optimization''}
        ...
        \begin{table}
            ...
            \begin{tabular}{ |l|c c|c c c|c c c|c c c| }
                ...
                \hline
            \end{tabular}
            } \caption{Porównanie miar jakości z uzyskanymi metodą \textit{ACO} w pracy ,,Ant Colony Optimization
