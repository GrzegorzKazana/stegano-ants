\chapter{Wyniki eksperymentów}\label{chap:results}
{
    ...
    \section{Metoda badawcza}
    {
        ...
        \subsection{Obrazy}
        {
            ...
            \textit{Mandrill} (znany także jako \textit{Baboon)}, \textit{Airplane (F-16) (a.k.a Jet)}, \textit{House}
            oraz \textit{Peppers}, które są udostępniane przez \textit{Uniwersytet Południowej Kalifornii
