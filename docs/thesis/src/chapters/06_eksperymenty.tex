\chapter{Wyniki eksperymentów}\label{chap:results}
{
    ...
    \section{Wyniki eksperymentów}
    {
        ...
        \subsection{Metoda oparta na wierzchołkach}
        {
            ...
            % METODA WIERZCHOŁKÓW - OSTATECZNE PORÓWNANIE
        ...
        \subsection{Metoda oparta na krawędziach}
        {
            ...
            liczba krawędzi będzie odwiedzana, lecz wnosi to również ryzyko otrzymywania nieoptymalnych rozwiązań.
            ...
            % METODA KRAWĘDZI - OSTATECZNE PORÓWNANIE
...
%
% - wariacje IWT + porównanie str. 24
