\chapter{Wyniki eksperymentów}\label{chap:results}
{
    ...
    \section{Wyniki eksperymentów}
    {
        ...
        \subsection{Metoda oparta o wierzchołki}
        {
            ...
            również ustalenie parametru $S$ określającego ilość kroków wykonywanych przez każdą mrówkę w każdej iteracji
            algorytmu.
            ...
            obserwacją płynącą z powyższego eksperymentu jest istotność doboru ilości mrówek $A$ oraz współczynnika
            związanego z odparowaniem śladu $\rho$. Macierze lepiej odzwierciedlające faktyczne segmenty obrazów
            powstały w przypadku konfiguracji charakteryzujących się większą ilością mrówek (na przykład
        ...
        \subsection{Metoda oparta o krawędzie}
        {
            ...
            Powyższy problem można rozwiązać na conajmniej dwa sposoby. Pierwszym jest odpowiedni dobór parametrów
            systemu mrówkowego, który będzie wymuszał na mrówkach częstszą eksplorację (na przykład wybór dużej wartości
            $\alpha$). Dzięki temu, większa ilość krawędzi będzie odwiedzana, lecz wnosi to również ryzyko otrzymywania
            ...
            uzyskany ślad feromonowy wskaże $V - \frac{V \times (V - 1)}{2}$ segmentów w których powinno zostać ukryte
            ...
            Rysunek \ref{fig:exp-edge-method} przedstawia segmentację każdego z obrazów nośnych na zadane ilości
    ...
    \section{Porównanie wyników z innymi metodami}
    {
        ...
        \begin{table}
            ...
            \begin{tabular}{ |l|c c c|c c c|c c c|c c c| }
                ...
                & \multicolumn{3}{p{4.5cm}|}{\centering Metoda oparta o \\ wierzchołki}
                & \multicolumn{3}{p{4.5cm}|}{\centering Metoda oparta o \\ krawędzie} \\
                \hline
